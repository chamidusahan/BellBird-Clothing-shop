...
$merchantId = "1225012";
$merchantSecret = "MTQ0NDgwNzE5OTIzMTAwNTY2NzEyODU5MzYyMDg0MTQ4Njk5OTg1OQ==";
$items = [];
$netTotal = 0;
$currency = "LKR";
$orderId = uniqid();
...
$payment["return_url"] = "http://localhost/myweb";
$payment["cancel_url"] = "http://localhost/myweb";
$payment["notify_url"] = "http://localhost/myweb/notify";
...
if ($num > 0) {
    ...
    $payment["address"] = $address['address'] . " " . $address['address2'];
    $payment['district'] = $address['district'];
