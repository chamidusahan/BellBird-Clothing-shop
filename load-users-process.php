        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    if ($row["status"] == '1') {
                    ?>
                        <button class="btn btn-sm btn-success w-100 rounded-circle" onclick="changeUserStatus(<?php echo ($row['id']); ?>, 0);">Active</button>
                    <?php
                    } else {
                    ?>
                        <button class="btn btn-sm btn-danger w-100 rounded-circle" onclick="changeUserStatus(<?php echo ($row['id']); ?>, 1);">Deactive</button>
                    <?php
                    }
                    ?>
